...
<!-- mail-us -->
	<div class="contact">
		<div class="container">
			<h3><span></span>新建社团</h3>
			<div class="contact-grid">
				<div class="col-md-7 contact-right">
					<form action="${pageContext.request.contextPath}/clubAction!addClub.action" method="post"  enctype="multipart/form-data">
						<input type="text" name="club.clubName" placeholder="社团名称" required=" "/>
						<div class="clearfix"> </div>
						<textarea name="club.introduction" placeholder="社团简介" required=" "></textarea>
						<input type="file" name="clubImage" value="选择图片"/>
