...
<!-- mail-us -->
	<div class="contact">
		<div class="container">
			<h3><span></span>用户信息修改</h3>
			<div class="contact-grid">
				<div class="contact-right">
					<form style="margin-left: 25%;" action="${pageContext.request.contextPath}/userAction!updateUser.action" method="post">
						<input type="text" name="user.nickName" value="<s:property value="user.nickName" />" placeholder="用户名" required=" "/><br>
						<input type="text" name="user.realName" value="<s:property value="user.realName" />" placeholder="真实姓名" required=" "/><br>
						<input type="text" name="user.age" value="<s:property value="user.age" />" placeholder="年龄" required=" "/><br>
						<input type="password" name="user.userPwd" placeholder="新密码"/><br>
