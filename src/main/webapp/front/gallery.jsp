			...
			<div class="services-grids">
				...
				<div class="col-md-3 services-grid">
					...
					<div class="services-grid1-bottom">
						<h4><a href="${pageContext.request.contextPath}/clubAction!intoGalleryBroswer.action?activity.activityId=<s:property value="activityId" />"><s:property value="activityName" /></a></h4>
					</div>
				</div>
            	</s:iterator>
