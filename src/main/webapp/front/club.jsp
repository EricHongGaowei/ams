					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						<nav class="link-effect-4" id="link-effect-4"> 
							<ul class="nav navbar-nav">
								<li><a href="${pageContext.request.contextPath}/clubAction!intoIndex.action" data-hover="首页">首页</a></li>
								<li class="active"><a href="${pageContext.request.contextPath}/clubAction!listClubs.action" data-hover="社团概览">社团概览</a></li>
			...
			<div class="services-grids">
				...
				<div class="col-md-3 services-grid">
					...
					<div class="services-grid1-bottom">
						<h4><a href="${pageContext.request.contextPath}/clubAction!clubDetail.action?club.clubId=<s:property value="clubId" />"><s:property value="clubName" /></a></h4>
						<p><s:property value="introduction" /></p>
						<div class="more">
							<a href="${pageContext.request.contextPath}/clubAction!intoClubApply.action?club.clubId=<s:property value="clubId" />"><span class="glyphicon glyphicon-log-in" aria-hidden="true"></span></a>
						</div>
					</div>
				</div>
            	</s:iterator>
