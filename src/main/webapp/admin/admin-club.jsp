...
<script type="text/javascript">
	...
	function freeze(id){
		$.ajax({url:"clubAction!freezeClub.action?club.clubId="+id,async:true,complete:pageReload});
	}
	
	function check(id){
		$.ajax({url:"clubAction!checkClub.action?club.clubId="+id,async:true,complete:pageReload});
	}
